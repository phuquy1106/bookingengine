...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  //   // Implement logic to truncate HTML content to a specific length or number of lines
  //   final RegExp exp = RegExp(r"<[^>]*>", multiLine: true, caseSensitive: true);
  //   String strippedHtml = htmlContent.replaceAll(exp, '');
  //   if (strippedHtml.length > 100) {
  //     strippedHtml = strippedHtml.substring(0, 100);
  //   }
  //   return '$strippedHtml...';
  // }
                  ...
                  child: Scaffold(
                        ...
                        Row(
                          children: [
                            Expanded(
                              ...
                              children: [
                                body(height.toDouble(), width.toDouble(),
                                    isMobile, homeController!),
                                isMobile
                                    ? BookingFormWigget(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    containerInformation(
                                        ...
                                        homeController!,
                                        homeController!.teAdult!
                                            .getRawString()),
                                    containerInformation(
                                        UITitleCode.TABLEHEADER_CHILD,
                                        homeController!,
                                        homeController!.teChild!
                                            .getRawString()),
                                    Row(
                                      crossAxisAlignment:
                    ...
                    bottomNavigationBar: isMobile
                        ? BottomNavigationBar(
                            ...
                            onTap: (int index) {
                              homeController!.changeScreenByIndex(index);
                            },
                            type: BottomNavigationBarType.fixed,
                            backgroundColor: ColorUtil.colorBackgroudMain,
                            showUnselectedLabels: false,
                            selectedItemColor: ColorManagement.orangeColor,
                            unselectedItemColor:
  ...
  Widget body(double height, double width, bool isMobile,
      ...
      SingleChildScrollView(
        ...
        Container(
          ...
          child: widget.roomType == null
              ...
              : layoutPicture(homeController!.listPrictureRoom,
                  GeneralManager.hotel!.layoutRoom!, context),
        ),
        Container(
                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //           width: width - (width * 0.078 * 2),
                        //           child: Html(
                        //             data: widget.roomType!.describeRoom,
                        //             style: {
                        //               "html": Style(
        ...
        Container(
          margin: EdgeInsets.only(right: width * 0.078, left: width * 0.078),
          height: 320,
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Divider(
            ...
            SizedBox(
              child: NeutronTextTitle(
                  message: widget.roomType == null
                      ? UITitleUtil.getTitleByCode(UITitleCode.HOTEL_FACILITIES)
                    ...
                    SizedBox(
                      ...
                      child: SfDateRangePicker(
                        ...
                        initialSelectedRange: PickerDateRange(
                            homeController?.inDate, homeController?.outDate),
                        monthViewSettings:
                            const DateRangePickerMonthViewSettings(
                                firstDayOfWeek: 4),
                        onSelectionChanged: (data) {
        ...
        widget.roomType == null
            ? homeController!.listRoomTypes.isNotEmpty
                ? Container(
                    margin: EdgeInsets.only(
                        right: width * 0.078, left: width * 0.078, bottom: 20),
                    child: Column(
                        children: homeController!.listRoomTypes
                            .where((element) =>
                                homeController!.listNumberRoom[element.id] >
                                    0 &&
                                homeController!.listNumberRoom[element.id] >=
                                    homeController!.teNumberRoom!
                                        .getNumber()! &&
                            ...
                            .map((e) => UiRoom(
                                  data: {
                                    ...
                                    'adult': controller.teAdult!.getNumber(),
                                    'child': controller.teChild!.getNumber(),
                                    'starDay': controller.startDay,
                                    'endDay': controller.endDay,
                                    'listNumberRoom': controller.listNumberRoom,
                                    'numberRoom':
                                        controller.teNumberRoom?.getNumber(),
                                  },
                                  roomType: e,
                                  number: homeController!.listNumberRoom[e.id],
                                ))
                            .toList()))
                : Align(
                    child: NeutronTextContent(
                ...
                ? Container(
                    ...
                    child: Column(
                        children: homeController
                                    ?.listNumberRoom[widget.roomType?.id] >
                                0
